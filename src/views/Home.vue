        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La creación de materiales educativos digitales se ha convertido en una habilidad indispensable para docentes y profesionales en entornos de aprendizaje virtual. En esta segunda unidad, se explorarán herramientas tecnológicas clave para diseñar, producir y evaluar recursos digitales innovadores, interactivos y pedagógicamente eficaces. El contenido aborda desde plataformas como H5P, Genially o Canva, hasta la creación de videos con Camtasia y estrategias de gamificación con Kahoot o Mentimeter.
              
              p #[b ¡Prepárese para crear experiencias de aprendizaje digitales con creatividad, funcionalidad y sentido pedagógico!]
